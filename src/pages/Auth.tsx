        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-glass/30 px-2 text-racing-light/70">Or continue with</span>
            </div>
          </div>
          ...
          <Button
            ...
            variant="outline"
            className="w-full mt-4 bg-white/10 border-white/20 text-racing-light hover:bg-white/20"
            disabled={loading}
          >
